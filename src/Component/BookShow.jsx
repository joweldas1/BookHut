...
solid
      ...
      <img  src={image}
          alt=""
          className="mx-auto  h-[250px] rounded-md p-6 dark:bg-[#F3F3F3]"
        />
        <div className="mt-6 mb-2 flex justify-between">
        <p className="bg-[#23BE0A] bg-opacity-5 text-[#23BE0A] font-bold workFair py-1 px-3 rounded-xl" > {category} </p>
        <p className="bg-[#23BE0A] bg-opacity-5 text-[#23BE0A] font-bold workFair py-1 px-3 rounded-xl" > {publisher} </p>
        </div>
